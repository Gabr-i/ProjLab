...
public class Map {
    ...
    public void LoadMap(){
    	...
    	for(int i=0;i<fields.size();i++) {
    		...
    		System.out.print(fields.get(i).index);
    	}
    }
    ...
    public void AddVirologist(){
        ...
        viro.get(0).setField(fields.get(0));
        fields.get(35).Accept(viro.get(1));
        viro.get(1).setField(fields.get(35));
        System.out.println(viro.get(1).getField().index);
        System.out.println(fields.get(34).index);
